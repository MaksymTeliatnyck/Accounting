...
namespace Accounting
{
    public partial class fixedAssetsManyTransferFm : Form
    {
        ...
        private void saveBtn_Click(object sender, EventArgs e)
        {
            ...
            bool supplierChange = (supplierNewCBox.EditValue != null);
            ...
            try
            {
                ...
                for (int i = 0; i < orderRowCount; i++)
                {
                    ...
                    newRow["Supplier_Id"] = (supplierChange) ? supplierNewCBox.EditValue : sourceDataTable.Rows[i]["Supplier_Id"];
        ...
        private void rejectChangesBtn_Click(object sender, EventArgs e)
        {
            ...
            supplierNewCBox.EditValue = null;
        ...
        private void setChangesBtn_Click(object sender, EventArgs e)
        {
            ...
            if (supplierChange)
            {
                sourceDataTable.AsEnumerable()
                    ...
                    .ForEach(r =>
                    {
                        r["SUPPLIER_NAME_NEW"] = supplierNewCBox.Text;
                        r["SUPPLIER_ID_NEW"] = supplierNewCBox.EditValue;
                    });
