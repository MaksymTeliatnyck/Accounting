    ...
    class DataModule : IDisposable
    {
        ...
        public void InitAdapter()
        {
            ...
            DataAdapter["Order"].InsertCommand.CommandText =
                @"INSERT INTO
                    Orders(Id, Order_Date, Receipt_Num, Invoice_Date, Invoice_Num, Vendor_Id, Supplier_Id, Supplier_Proxy, Debit_Account_Id, Total_With_Vat, Correction, Tax_Invoice, Transport_Invoice, ""Color_Id"", Checked, ""Flag1"", ""Flag2"", ""Flag3"", ""Flag4"", ""Otk_Id"", ""Storekeeper_Id"", Currency_Id, Currency_Rate)
                VALUES
                    (@Id, @Order_Date, @Receipt_Num, @Invoice_Date, @Invoice_Num, @Vendor_Id, @Supplier_Id, @Supplier_Proxy, @Debit_Account_Id, @Total_With_Vat, @Correction, @Tax_Invoice, @Transport_Invoice, @Color_Id, @Checked, @Flag1, @Flag2, @Flag3, @Flag4, @Otk_Id, @Storekeeper_Id, @Currency_Id, @Currency_Rate)";
            ...
            DataModule.DataAdapter["Invoice_Requirement_Materials"].SelectCommand.CommandText =
                                               @"SELECT
                                                   ...
                                                   WHERE
                                                        ""Invoice_Requirement_Materials"".""Invoice_Requirement_Order_Id"" = @Id AND
                                                       (""Invoice_Requirement_Materials"".""Credit_Account_Id"" != 18 OR
                                                         ""Invoice_Requirement_Materials"".""Credit_Account_Id"" is NULL)
            ...
            DataModule.DataAdapter["CalcWithBuyers"].SelectCommand.CommandText =
                                                 @"SELECT
                                                    ...
                                                    LEFT JOIN
                                                        ""CustomerOrders"" as c_o ON c.""CustomerOrderId"" = c_o.""Id""
                                                    LEFT JOIN 
            ...
            DataModule.DataAdapter["CalcWithBuyers"].InsertCommand.CommandText =
                                        @"INSERT INTO ""CalcWithBuyers""(""DocumentName"", ""DocumentDate"", ""Payment"", ""BalanceAccountId"", ""PurposeAccountId"", 
                                                      ""ContractorsId"", ""EmployeesId"", ""CurrencyRatesId"", ""Comment"", ""AccountingOperationId"", ""CustomerOrderId"") 
                                               VALUES(@DocumentName, @DocumentDate, @Payment, @BalanceAccountId, @PurposeAccountId, @ContractorsId, @EmployeesId, 
                                                      @CurrencyRatesId, @Comment, @AccountingOperationId, @CustomerOrderId) RETURNING ""Id""";
            ...
            DataModule.DataAdapter["CalcWithBuyers"].InsertCommand.Parameters.Add("CustomerOrderId", FbDbType.Integer, 4, "CustomerOrderId");
            ...
            DataModule.DataAdapter["CalcWithBuyers"].UpdateCommand.Parameters.Add("CustomerOrderId", FbDbType.Integer, 4, "CustomerOrderId");
