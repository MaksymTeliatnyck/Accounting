...
namespace Accounting
{
    public partial class reportsFm : Form
    {
        ...
        private void reportFm_Load(object sender, EventArgs e)
        {
            ...
            yearBeginCBox.DataSource = DataModule.ExecuteFill
            (
                @"SELECT DISTINCT
            ...
            yearEndCBox.DataSource = ((DataTable)yearBeginCBox.DataSource).Copy();
        ...
        private void typeCBox_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            debtorsCreditorsBtn.Enabled = (typeCBox.Text != "681" && typeCBox.Text != "39");
            paymentsWithoutVatBtn.Enabled = (typeCBox.Text != "632" && typeCBox.Text != "681" && typeCBox.Text != "39");
            contractorsVatBtn.Enabled = (typeCBox.Text != "632" && typeCBox.Text != "681" && typeCBox.Text != "39");
            reconciliationBtn.Enabled = (typeCBox.Text != "39");
            msTrialBalanceBtn.Enabled = (typeCBox.Text != "39");
        ...
        private void msTrialBalanceByAccountsBtn_Click(object sender, EventArgs e)
        {
            ...
            switch (typeCBox.Text)
            {
                ...
                case "39":
                    ...
                    Report.MSTrialBalanceByAccounts39(DataModule.ExecuteFillProc("ReportTrialBalanceByAccount39", Parameters39), StartDate.Substring(3), EndDate.Substring(3), typeCBox.Text);
                    break;
                default:
                    FbParameter[] Parameters =
                    {
