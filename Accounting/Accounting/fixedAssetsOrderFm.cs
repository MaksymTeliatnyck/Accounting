    ...
    public partial class fixedAssetsOrderFm : Form
    {
        ...
        private void actWriteOffBtn_Click(object sender, EventArgs e)
        {
            ...
            if (DataModule.AccountingDS.Tables["FixedAssetsMaterials"].Rows.Count > 0)
            {
                ...
                DateTime SearchDate = DateTime.Parse(yearEndCBox.Text + "-" +(monthEndCBox.SelectedIndex + 1) + "-" + "01");

                switch (group)
                {
                    case 10:
                    case 2:
                        Report.FixedAssetsOrderActWriteOff((DataRowView)fixedAssetsOrderBS.Current, Utils.FixedAssetsGroup.SoftWare, SearchDate);
                        //Report.FixedAssetsOrderActForSoftWare((DataRowView)fixedAssetsOrderBS.Current);
                        break;
                    default:
                        Report.FixedAssetsOrderActWriteOff((DataRowView)fixedAssetsOrderBS.Current, Utils.FixedAssetsGroup.General, SearchDate);
                        //Report.FixedAssetsOrderAct((DataRowView)fixedAssetsOrderBS.Current);
                        break;
                }
            }
        ...
        private void printBtn_Click(object sender, EventArgs e)
        {
            ...
            DataTable BaseDataTable = DataModule.ExecuteFill(DataModule.Queries["FixedAssetsOrderPrintHistory"] + " AND  \"FixedAssetsOrder\".\"Id\"  in (" + query.ToString() + ")", Parameters);
            ...
            report.FixedAssetsPrintItem(((DataRowView)fixedAssetsOrderBS.Current)["Id"].ToString(),BaseDataTable, Convert.ToDateTime(beginDateForReport), Convert.ToDateTime(endDateForReport));
            Cursor = Cursors.Default;
        }
        ...
        private void fixedAssetsAddedPriceDecreeItem_Click(object sender, EventArgs e)
        {
            Reports Report;
            Report = new Reports();
            DateTime StartDate = DateTime.Now, EndDate = DateTime.Now;
            ...
            if (DataModule.AccountingDS.Tables["FixedAssetsMaterials"].Rows.Count > 0)
            {
                ...
                if((Convert.ToInt32(((DataRowView)fixedAssetsMaterialsBS.Current)["FLAG"])) == 1)
                    Report.FixedAssetsDecreeAddedPrice((DataRowView)fixedAssetsOrderBS.Current, (DataRowView)fixedAssetsMaterialsBS.Current);
                else
                    MessageBox.Show(" Обрано не вірний матеріал! \n Виберіть матеріл, який збільшив вартість основного засобу.", "Увага", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void fixedAssetsInputDecreeItem_Click(object sender, EventArgs e)
        {
            Reports Report;
            Report = new Reports();
            DateTime StartDate = DateTime.Now, EndDate = DateTime.Now;
            ...
            if (DataModule.AccountingDS.Tables["FixedAssetsMaterials"].Rows.Count > 0)
            {
                Report.FixedAssetsDecreeInput((DataRowView)fixedAssetsOrderBS.Current);
        ...
        private void fixedAssetsSoldDecreeBtn_Click(object sender, EventArgs e)
        {
            Reports Report;
            Report = new Reports();
            DateTime StartDate = DateTime.Now, EndDate = DateTime.Now;
           // if(sta)
            ...
            FbParameter[] Parameters =
                {
                    new FbParameter("Id", ((DataRowView)fixedAssetsArchiveBS.Current)["Id"])
                };

            if (DataModule.AccountingDS.Tables["FixedAssetsArchive"].Rows.Count > 0)
            {
                if ((Convert.ToInt16(((DataRowView)fixedAssetsArchiveBS.Current)["OperationStatus"])) == 2 || (Convert.ToInt16(((DataRowView)fixedAssetsArchiveBS.Current)["OperationStatus"])) == 4)
                {

                    short group = (short)((DataRowView)fixedAssetsArchiveBS.Current)["Group_Id"];
                    switch (group)
                    {
                        case 10:
                        case 2:
                            Report.FixedAssetsOrderActForSaleSoftWare((DataRowView)fixedAssetsArchiveBS.Current);
                            break;
                        default:
                            Report.FixedAssetsDecreeSold((DataRowView)fixedAssetsArchiveBS.Current);
                            break;
                    }
                }
                else
                    MessageBox.Show("Обрано картку основного, який не було продано ", "Увага", MessageBoxButtons.OK, MessageBoxIcon.Information);
           }
            else
                {
                    MessageBox.Show("Виберіть з архіву картку основного засобу", "Увага", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            Cursor = Cursors.Default;
        ...
        private void fixedAssetsDecreeBtn_Click(object sender, EventArgs e)
        {
