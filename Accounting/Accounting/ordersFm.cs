...
namespace Accounting
{
    public partial class ordersFm : Form
    {
        ...
        public ordersFm(bool isCurrencyOrder) // Currency flag, true - curency order and 632 account, false - UAN order and 631, 63 accounts
        {
            ...
            yearBeginCBox.SelectedIndex = 10;
            ...
            DataModule.AccountingDS.Tables["DeliveryOrderDetails"].Rows.Clear();
            ...
            DataModule.AccountingDS.Tables["Order"].Columns["Transport_Invoice"].DefaultValue = 0;
        ...
        {
            DataModule.DataAdapter["DeliveryOrderDetails"].Fill(DataModule.AccountingDS.Tables["DeliveryOrderDetails"]);
        ...
        private void SelectDate()
        {
            ...
            ordersGridView.BeginSummaryUpdate(); 
            
            ordersGridView.EndSummaryUpdate();
        }
        ...
        private void SelectDeliveryOrders()
        {
            if (ordersGridView.RowCount > 0 && ordersBS.Position != -1 && !Inserting)
            {

                ////long? orderId = (long?)DataModule.AccountingDS.Tables["Order"].Rows[ordersBS.Position]["Id"];
                //DataModule.DataAdapter["DeliveryOrderDetails"].SelectCommand.Parameters["Order_Id"].Value = DataModule.AccountingDS.Tables["Order"].Rows[ordersBS.Position]["Id"];
                //DataModule.AccountingDS.Tables["DeliveryOrderDetails"].Rows.Clear();
                //DataModule.DataAdapter["DeliveryOrderDetails"].Fill(DataModule.AccountingDS.Tables["DeliveryOrderDetails"]);

                DataModule.DataAdapter["DeliveryOrderDetails"].SelectCommand.Parameters["Order_Id"].Value = ((DataRowView)ordersBS.Current)["Id"];
                DataModule.AccountingDS.Tables["DeliveryOrderDetails"].Rows.Clear();
                DataModule.DataAdapter["DeliveryOrderDetails"].Fill(DataModule.AccountingDS.Tables["DeliveryOrderDetails"]);
            }
        }
       ...
       /// <summary>
        ...
        {
             Cursor = Cursors.WaitCursor;
            deliveryFm deliveryFm = new deliveryFm
            (
                dateStart, dateEnd
            );
            deliveryFm.MdiParent = Program.MainFm;
            deliveryFm.Show();
            Cursor = Cursors.Default;
        }
    }
