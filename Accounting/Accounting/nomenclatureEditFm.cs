...
namespace Accounting
{
    public partial class nomenclatureEditFm : Form
    {
        ...
        public nomenclatureEditFm(bool inserting, int position = -1, int nomenclatureId = -1)
        {
            InitializeComponent();

            _inserting = inserting;
            _nomenclatureId = _inserting ? -1 : nomenclatureId;

            
            generateChkBox.Visible = _inserting;
            generateChkBox.Checked = _inserting;
